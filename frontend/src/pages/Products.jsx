...
const Products = () => {
  ...
  const structuredData = {
    ...
    "@type": "ItemList",
    "name": "Productos Profesionales para Peluquería",
    "description": "Amplia selección de productos profesionales para peluquería",
    "url": "https://franco-salon-exclusivo.com/products",
  ...
  return (
    <div className="min-h-screen bg-black gray-particles">
      <SEO 
        title="Productos Profesionales para Peluquería - Franco Salon Exclusivo"
        description="Explora nuestra amplia gama de productos profesionales para peluquería: aceites, acondicionadores, aerosoles, ceras, geles, máscaras, oxidantes, shampoos y sprays. Calidad premium para profesionales del cabello."
        keywords="productos peluquería profesional, aceite cabello, acondicionador, aerosol fijador, cera peinado, gel cabello, máscara capilar, oxidantes, shampoo profesional, spray fijador, franco salon exclusivo"
        url="/products"
           ...
           <div className="flex flex-col gap-6">
             ...
             <div className="w-full">
               <div className="relative max-w-md">
                 ...
                 <input
                   ...
                   className="w-full h-16 pl-14 pr-6 bg-gray-800 border border-gray-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-300 text-lg font-medium"
                   style={{ color: 'white' }}
                 />
               </div>
             </div>
             ...
             <div className="flex flex-wrap items-center gap-4">
               ...
               <select
                 ...
                 className="px-4 py-2 bg-gray-800 border border-gray-500/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-300"
               >
                 ...
                 <option value="price-high" className="bg-gray-800">Precio: mayor a mayor</option>
               </select>
               ...
               <div className="flex border border-gray-500/30 rounded-lg overflow-hidden">
                 <button
                   ...
                   className={`p-3 ${viewMode === 'grid' ? 'bg-gray-500 text-white' : 'bg-gray-800 text-gray-400 hover:bg-gray-500/20'}`}
                 >
                   <Grid className="h-5 w-5" />
                 </button>
                 <button
                   onClick={() => setViewMode('list')}
                   className={`p-3 ${viewMode === 'list' ? 'bg-gray-500 text-white' : 'bg-gray-800 text-gray-400 hover:bg-gray-500/20'}`}
                 >
      ...
      {viewMode === 'grid' ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {sortedProducts.map((product) => (
            <Card key={product.id} className="elegant-card hover:shadow-2xl hover:shadow-gray-500/20 transition-all duration-500 group hover:scale-105  overflow-hidden">
        ...
        <div className="space-y-6">
          {sortedProducts.map((product) => (
            <Card key={product.id} className="elegant-card hover:shadow-2xl hover:shadow-gray-500/20 transition-all duration-500 group hover:scale-[1.02]  overflow-hidden">
              <div className="flex">
