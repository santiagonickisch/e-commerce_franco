              ...
              <div key={stepNumber} className="flex items-center">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${
                  step >= stepNumber 
                    ...
                    : 'bg-elegant-gray text-gold-400 border border-gold-500/30'
                }`}>
                ...
                {stepNumber < 3 && (
                  <div className={`w-20 h-1 mx-4 transition-all duration-300 ${
                    step > stepNumber ? 'bg-gold-500' : 'bg-elegant-gray border border-gold-500/30'
                  }`} />
                )}
              </div>
            ))}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            required
                            className="w-full h-12 pl-12 pr-4 bg-elegant-gray border border-gold-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-gold-500 transition-all duration-300"
                ...
                {step === 2 && (
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div>
                        <label className="block text-gold-300 text-sm font-medium mb-2">País</label>
                        <div className="relative">
                          <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gold-400 h-5 w-5" />
                          <input
                            type="text"
                ...
                {step === 3 && (
                  <>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <CreditCard className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gold-400 h-5 w-5" />
                        <input
                          type="text"
                          name="cardNumber"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-gold-300 text-sm font-medium mb-2">Fecha de expiración</label>
                        <div className="relative">
                          <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gold-400 h-5 w-5" />
                          <input
                            type="text"
                            name="expiryDate"
                      ...
                      <div>
                        <label className="block text-gold-300 text-sm font-medium mb-2">CVV</label>
                        <div className="relative">
                          <Shield className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gold-400 h-5 w-5" />
                          <input
                            type="text"
                            name="cvv"
                            value={formData.cvv}
                ...
                <div className="flex justify-between pt-8">
                  {step > 1 && (
                    <Button
                      ...
                      className="border-gold-500 text-gold-400 hover:bg-gold-500 hover:text-black transition-all duration-300"
                    >
                      Anterior
                    </Button>
                  )}
          ...
          <div className="lg:col-span-1">
            <Card className="elegant-card gold-border">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-center gap-4 p-4 bg-elegant-gray rounded-lg">
                  <img
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gold-300">Cantidad: 1</p>
                  </div>
                  <span className="font-medium text-gold-400">$999.99</span>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-elegant-gray rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gold-300">Cantidad: 2</p>
                  </div>
                  <span className="font-medium text-gold-400">$2,399.98</span>
                </div>
              </div>
              ...
              <div className="space-y-4 border-t border-gold-500/30 pt-6">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gold-400">Gratis</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-8 pt-6 border-t border-gold-500/30">
                <div className="flex items-center gap-3 text-sm text-gold-300 mb-3">
