...
const Home = () => {
  ...
  const structuredData = {
    ...
    "logo": "https://franco-salon-exclusivo.com/logo.png",
    "sameAs": [
      "https://www.facebook.com/francosalonexclusivo",
      "https://www.instagram.com/francosalonexclusivo"
    ],
    "contactPoint": {
      "@type": "ContactPoint",
  ...
  return (
    <div className="min-h-screen bg-black gray-particles">
      <SEO 
        title="Franco Salon Exclusivo - Productos Profesionales para Peluquería"
        description="Descubre nuestra amplia selección de productos profesionales para peluquería: aceites, acondicionadores, aerosoles, ceras, geles, máscaras, oxidantes, shampoos y sprays. Calidad premium para profesionales."
        keywords="franco salon exclusivo, productos peluquería, aceite cabello, acondicionador profesional, aerosol fijador, cera peinado, gel cabello, máscara capilar, oxidantes, shampoo profesional, spray fijador"
      ...
      <section className="relative bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
          <div className="text-center">
            <div className="mb-8">
              <div className="logo-container mx-auto max-w-md">
                <img 
                  src="/logo-franco.jpg" 
                  alt="Franco Salon Exclusivo" 
                  className="logo-image w-full h-auto object-contain"
                />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link to="/register">
                <Button variant="outline" size="lg" className="text-lg px-10 py-4 border-gray-500 text-gray-400 hover:bg-gray-500 hover:text-white transition-all duration-300">
                  Únete Ahora
                </Button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            {categories.map((category) => (
              <Link
                ...
                className="elegant-card rounded-xl p-8 text-center hover:shadow-2xl hover:shadow-gray-500/20 transition-all duration-500 group hover:scale-105"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="bg-gradient-to-br from-gray-500 to-gray-600 text-white rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
