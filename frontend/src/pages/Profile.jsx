    ...
    <div className="min-h-screen bg-black gray-particles">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 text-xl">Gestiona tu información personal y preferencias</p>
        </div>
                ...
                {!isEditing ? (
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      className="flex items-center gap-2 border-gold-500 text-gray-400 hover:bg-gold-500 hover:text-black"
                    >
                      <X className="w-4 h-4" />
                      Cancelar
                    </Button>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        className="w-full h-12 pl-12 pr-4 bg-gray-800 border border-gold-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-gold-500 transition-all duration-300 disabled:opacity-50"
          ...
          <div className="lg:col-span-1 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                  <div>
                    ...
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                      user?.isActive 
                        ? 'bg-gold-500/20 text-gray-400 border border-gold-500/30' 
            ...
            <Card className="elegant-card ">
              ...
              <div className="space-y-4">
                <Button variant="outline" className="w-full justify-start border-gold-500 text-gray-400 hover:bg-gold-500 hover:text-black transition-all duration-300">
